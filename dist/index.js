(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@/.lazybee')) :
  typeof define === 'function' && define.amd ? define(['@/.lazybee'], factory) :
  (global = global || self, global.SongPackage = factory(global.options));
  ...
  function assertRawModule(path, rawModule) {
    Object.keys(assertTypes).forEach(function (key) {
      ...
      forEachValue(rawModule[key], function (value, type) {
        assert$1(assertOptions.assert(value), makeAssertionMessage(path, key, type, value, assertOptions.expected));
      });
    });
  }
  ...
  autoVuex.install = index_esm.install;
  ...
  function install$2(_Vue) {
    /* istanbul ignore if */
    if (process.env.NODE_ENV !== 'production' && install$2.installed && _Vue === Vue$1) {
    ...
    if (process.env.NODE_ENV !== 'production' && version < 2) {
      warn$1("vue-i18n (" + install$2.version + ") need to use Vue 2.0 or later (Vue: " + Vue$1.version + ").");
      return;
    }

    extend$1(Vue$1);
    Vue$1.mixin(mixin);
    Vue$1.directive('t', { bind: bind, update: update$1, unbind: unbind });
  ...
  function compile$1(tokens, values) {
    ...
    var mode = Array.isArray(values) ? 'list' : isObject$1(values) ? 'named' : 'unknown';
    if (mode === 'unknown') {
      return compiled;
    }
  ...
  prototypeAccessors$2.vm.get = function () {
    return this._vm;
  };

  prototypeAccessors$2.messages.get = function () {
    return looseClone(this._getMessages());
  };
  prototypeAccessors$2.dateTimeFormats.get = function () {
    return looseClone(this._getDateTimeFormats());
  };
  prototypeAccessors$2.numberFormats.get = function () {
    return looseClone(this._getNumberFormats());
  };
  prototypeAccessors$2.availableLocales.get = function () {
  ...
  prototypeAccessors$2.fallbackLocale.get = function () {
  ...
  prototypeAccessors$2.missing.get = function () {
    return this._missing;
  };
  prototypeAccessors$2.missing.set = function (handler) {
    this._missing = handler;
  };

  prototypeAccessors$2.formatter.get = function () {
    return this._formatter;
  };
  prototypeAccessors$2.formatter.set = function (formatter) {
    this._formatter = formatter;
  };

  prototypeAccessors$2.silentTranslationWarn.get = function () {
    return this._silentTranslationWarn;
  };
  prototypeAccessors$2.silentTranslationWarn.set = function (silent) {
    this._silentTranslationWarn = silent;
  };

  prototypeAccessors$2.silentFallbackWarn.get = function () {
    return this._silentFallbackWarn;
  };
  prototypeAccessors$2.silentFallbackWarn.set = function (silent) {
    this._silentFallbackWarn = silent;
  };

  prototypeAccessors$2.preserveDirectiveContent.get = function () {
    return this._preserveDirectiveContent;
  };
  prototypeAccessors$2.preserveDirectiveContent.set = function (preserve) {
    this._preserveDirectiveContent = preserve;
  };

  prototypeAccessors$2.warnHtmlInMessage.get = function () {
