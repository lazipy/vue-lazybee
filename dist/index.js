(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-router'), require('vuex'), require('vue-i18n'), require('js-cookie'), require('@/.lazybee')) :
  typeof define === 'function' && define.amd ? define(['vue-router', 'vuex', 'vue-i18n', 'js-cookie', '@/.lazybee'], factory) :
  (global = global || self, global.SongPackage = factory(global.Router, global.Vuex, global.Vuei18n, global.Cookies, global.options));
}(this, function (Router, Vuex, Vuei18n, Cookies, options) { 'use strict';
